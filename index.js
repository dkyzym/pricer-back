...
app.get('/search-code', async (req, res) => {
  try {
    ...
    // Извлечение нужных данных (пример)
    const data = $('body').html(); // адаптируй под нужные элементы
...
//       const cookieOptionsObject = {};

//       cookieOptions.forEach((option) => {
//         const [key, value] = option.split('=');
//         cookieOptionsObject[key.toLowerCase()] = value || true;
//       });

//       console.log(
//         `Setting cookie: ${cookieName}=${cookieValue}`,
//         cookieOptionsObject
//       );

//       res.cookie(cookieName, cookieValue, {
//         httpOnly: !!cookieOptionsObject['httponly'],
//         secure: !!cookieOptionsObject['secure'],
//         sameSite: 'None',
//         path: cookieOptionsObject['path'] || '/', // Установка правильного пути
//         domain: 'turbo-cars.net', // Установка правильного домена
//       });
//     });
...
//     // Извлечение нужных данных (пример)
//     const data = $('body').text(); // адаптируй под нужные элементы
